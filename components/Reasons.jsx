...
export default function Reasons() {
  return (
    <div className="py-5 d-flex flex-column justify-content-around align-items-center w-100 reasons">
      <h2>چرا مکالمه آنلاین ؟</h2>
      <Row className="w-75 text-right justify-content-around align-items-center">
        <Col sm={12} md={3} className="my-1 my-md-0">
